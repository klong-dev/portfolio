...
export default function Timeline() {
  return (
    <div className="max-w-4xl mx-auto p-4 bg-gray-100 dark:bg-gray-900 rounded-lg shadow">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div>
          ...
          <div className="space-y-8">
            <TimelineItem
              ...
              tags={["ReactJS", "NestJS"]}
            />
            <TimelineItem title="Web Developer (Freelance)" date="2021 - 2023" icon={<BriefcaseIcon className="h-5 w-5" />} description="Architecting and developing dynamic web applications. Building custom CMS solutions. Implementing front-end interfaces using VueJS." tags={["PHP", "Laravel", "VueJS"]} />
            <TimelineItem
        ...
        <div>
          ...
          <div className="space-y-8">
            <TimelineItem title="FPT University Ho Chi Minh City" subtitle="Software Engineering" date="2022 - Present" icon={<AcademicCapIcon className="h-5 w-5" />} />
          </div>
          <h2 className="text-2xl font-bold my-4 text-gray-900 dark:text-white">Project Leadership</h2>
          <div className="space-y-8">
            <TimelineItem title="Team Leader - SWP391 Course Project" date="2024" icon={<UsersIcon className="h-5 w-5" />} description="Led development of 'FPT Mentor' platform. Managed team workflow and project deliverables. Coordinated with stakeholders and supervised technical implementation." />
          </div>
        </div>
      </div>
    </div>
